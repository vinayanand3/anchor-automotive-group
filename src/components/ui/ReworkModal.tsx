...
import { X, Wrench, CheckCircle2, ShieldCheck, Microscope, ArrowUpRight } from "lucide-react";
        ...
        >
          ...
          {submitted ? (
            <div className="text-center py-12 space-y-4">
              ...
              <h4 className="text-xl font-normal text-paper-ink tracking-tight">Rework Ticket Initiated</h4>
              <p className="text-paper-label text-xs max-w-md mx-auto leading-relaxed font-light">
                Ticket Reference <span className="font-mono text-paper-ink font-semibold">#REWORK-NOVI-8492</span> created. Our shop floor team will review your part specifications and contact you immediately.
              </p>
              <button
